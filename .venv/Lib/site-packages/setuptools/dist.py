...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'test_suite' -- the name of a __________ suite to run for the '__________' command.
        If the user runs 'python setup.py __________', the package will be installed,
        and the named __________ suite will be run.  The format is the same as
        would be used on a 'unittest.py' command line.  That is, it is the
        dotted name of an object to import and call to generate a __________ suite.
        ...
        if not os.path.exists(egg_cache_dir):
            ...
            with open(readme_txt_filename, 'w') as f:
                f.write(
                    ...
                    'by setuptools to build, __________, and run plug-ins.\n\n'
                )
                f.write(
